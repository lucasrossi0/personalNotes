...
<br>
<br>
<li>Verifying the functionality of the application, or a specific method or function;</li>
<li>Detecting bugs or errors, its better and cheaper to find them in development rather than production;</li>
<li>Improve code quality, ensuring that the output of the application is what its expected to be.</li>
